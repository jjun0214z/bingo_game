...
function (_Component) {
  ...
  function BingoCell() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "_handlePlayer", function (player, turn, selectingNumber) {
      console.log(11121212);

      if (player === "player1" && turn || player === "player2" && !turn) {
        return selectingNumber;
      } else if (player === "player1" && turn || player === "player2" && !turn) {// console.log(11);
      } else {
        return null;
      }
    });
...
//# sourceMappingURL=index.js.27ad9525e8869c26e6ac.hot-update.js.map