...
function (_Component) {
  ...
  function BingoCell() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "_handlePlayer", function (player, turn, selectingNumber, notTurn) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(BingoCell, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Button, {
        activeklass: activeklass // onClick={this._handlePlayer(player, bingoSet.turn, selectingNumber, notTurn)}
        ,
        onClick: player === "player1" && turn || player === "player2" && !turn ? selectingNumber : notTurn,
        __source: {
...
//# sourceMappingURL=index.js.43c053f5190e37322ed7.hot-update.js.map